(function ($) {
  ...
  */
  ...
  theme.icons = {
    ...
    chevronLefts:'<svg fill="#000000" height="200" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><title>' + theme.strings.icon_labels_left + '</title><path d="M50 100 L150 150 L 150 50 Z" fill="#6f894e"/></svg>',
    ...
    chevronRights:'<svg fill="#000000" height="200" viewBox="0 0 200 200" width="200" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-left"><title>' + theme.strings.icon_labels_left + '</title><path d="M50 50 L50 150 L 150 100 Z" fill="#6f894e"/></svg>',
    ...
    this.onSectionLoad = function (container) {
      $('.slideshow', container).each(function () {
        ...
        $(this).on('init', function () {
          ...
          infinite: true,
          useTransform: true,
          prevArrow: '<button type="button" class="slick-prev" aria-label="' + theme.strings.previous + '">' + theme.icons.chevronLefts + '</button>',
          nextArrow: '<button type="button" class="slick-next" aria-label="' + theme.strings.next + '">' + theme.icons.chevronRights + '</button>',
          customPaging: function customPaging(slider, i) {
